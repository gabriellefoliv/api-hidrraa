...
async function main() {
  await prisma.tipo_projeto.createMany({
    data: [
      ...
      },
      {
        ...
        descricao:
          'Projeto dedicado à implementação de práticas mecânicas e vegetativas de conservação do solo para controle de processos erosivos em áreas rurais, contribuindo para a redução do assoreamento dos corpos hídricos.',
      },
      {
        codTipoProjeto: 3,
  ...
  await prisma.marco_recomendado.createMany({
    data: [
      ...
      },
      {
        ...
        descricao: 'Preparo do Solo e Controle de Formigas',
        codTipoProjeto: 4,
      },
      {
  ...
  await prisma.evidencia_demandada.createMany({
    data: [
      ...
      },
      {
        ...
        descricao: 'Fotos georreferenciadas do estado atual das nascentes',
      ...
      },
      {
        ...
        descricao: 'Fotos da cerca concluída com pontos de georreferenciamento',
        tipoArquivo: 'image/jpeg',
        codMarcoRecomendado: 2,
      },
      {
      ...
      },
      {
        ...
        descricao:
          'Lista de espécies utilizadas com ART do responsável técnico',
        tipoArquivo: 'application/pdf',
        codMarcoRecomendado: 3,
      },
      {
      ...
      },
      {
        ...
        descricao: 'Fotos da construção das estruturas de proteção',
        tipoArquivo: 'image/jpeg',
        codMarcoRecomendado: 4,
      },
      {
      ...
      },
      {
        ...
        descricao: 'Relatório de manutenção com fotos',
        tipoArquivo: 'application/pdf',
        codMarcoRecomendado: 5,
      },
      {
        codEvidenciaDemandada: 14,
        descricao: 'Fotos comparativas (antes/depois) georreferenciadas',
        tipoArquivo: 'image/jpeg',
        codMarcoRecomendado: 5,
      },
      {
        codEvidenciaDemandada: 15,
        descricao: 'Relatório de medições de vazão (se aplicável)',
        tipoArquivo: 'application/pdf',
        codMarcoRecomendado: 5,
      },
      {
        codEvidenciaDemandada: 16,
        descricao: 'Mapa de áreas degradadas com pontos críticos de erosão',
        tipoArquivo: 'application/pdf',
        codMarcoRecomendado: 6,
      },
      {
        codEvidenciaDemandada: 17,
        descricao: 'Fotos georreferenciadas do estado atual da erosão',
        tipoArquivo: 'image/jpeg',
        codMarcoRecomendado: 6,
      },
      {
      ...
      },
      {
        ...
        descricao: 'Fotos do processo de construção das barraginhas',
        tipoArquivo: 'image/jpeg',
        codMarcoRecomendado: 7,
      },
      {
      ...
      },
      {
        ...
        descricao: 'Notas fiscais de materiais e serviços',
        tipoArquivo: 'application/pdf',
        codMarcoRecomendado: 7,
      },
      {
      ...
      },
      {
        ...
        descricao: 'Lista de espécies utilizadas no plantio de cobertura',
        tipoArquivo: 'application/pdf',
        codMarcoRecomendado: 9,
      },
      {
      ...
      },
      {
        ...
        descricao:
          'Relatório de levantamento das condições sanitárias da propriedade',
        tipoArquivo: 'application/pdf',
        codMarcoRecomendado: 10,
      },
      {
        codEvidenciaDemandada: 28,
        descricao: 'Planta baixa com localização dos sistemas de saneamento',
        tipoArquivo: 'application/pdf',
        codMarcoRecomendado: 10,
      },
      {
      ...
      },
      {
        ...
        descricao: 'Notas fiscais de materiais e serviços prestados',
        tipoArquivo: 'application/pdf',
        codMarcoRecomendado: 11,
      },
      {
      ...
      },
      {
        ...
        descricao: 'Notas fiscais dos equipamentos e materiais',
        tipoArquivo: 'application/pdf',
        codMarcoRecomendado: 12,
      },
      {
        codEvidenciaDemandada: 33,
        descricao: 'Lista de presença da capacitação',
        tipoArquivo: 'application/pdf',
        codMarcoRecomendado: 13,
      },
      {
        codEvidenciaDemandada: 34,
        descricao: 'Material didático utilizado na capacitação',
        tipoArquivo: 'application/pdf',
        codMarcoRecomendado: 13,
      },
      {
        codEvidenciaDemandada: 35,
        descricao: 'Relatório fotográfico da capacitação',
        tipoArquivo: 'application/pdf',
        codMarcoRecomendado: 13,
      },
    ],
  ...
  await prisma.cbh.create({
    data: {
      codCBH: 1,
      nome: 'Comitê da Bacia Hidrográfica do Rio Dois Rios',
    },
  })
    ...
    data: [
      {
        ...
        complemento: 'Sítio Santo Antônio',
        cep: '28600000',
        uf: 'RJ',
        codProdutor: 1,
        CodMicroBacia: 1,
      ...
      {
        codPropriedade: 2,
        logradouro: 'Estrada do Comércio',
        numero: 45,
        bairro: 'Zona Rural',
        cidade: 'Bom Jardim',
        complemento: 'Fazenda Boa Esperança',
        cep: '28660000',
        uf: 'RJ',
        codProdutor: 2,
        CodMicroBacia: 2,
